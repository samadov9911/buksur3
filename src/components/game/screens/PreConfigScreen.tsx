...
function NanoSatConfigStep({
  ...
  return (
    ...
    >
      ...
      <div className="rounded-xl border border-gray-600/20 bg-gray-900/30 p-3 mb-4 max-h-[100px] overflow-y-auto summary-scroll md:max-h-none md:overflow-visible">
