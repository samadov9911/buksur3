...
function NanoSatConfigStep({
  ...
  return (
    ...
    >
      ...
      <div className="pr-1 md:flex-1 md:overflow-y-auto md:min-h-0 scroll-inner max-h-[35vh] overflow-y-auto">
...
function DebrisConfigStep({
  ...
  return (
    ...
    >
      ...
      <div className="scroll-inner pr-1 md:flex-1 md:overflow-y-auto md:min-h-0 max-h-[35vh] overflow-y-auto">
        <div className="rounded-xl border border-gray-600/30 bg-gray-900/50 p-4 md:p-5 mb-4">
